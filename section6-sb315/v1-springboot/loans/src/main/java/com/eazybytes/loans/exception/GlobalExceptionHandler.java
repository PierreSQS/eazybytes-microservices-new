...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleConstraintViolation(ConstraintViolationException ex, WebRequest webRequest) {
        ...
        List<Map<String, String>> validationErrorList = ex.getConstraintViolations().stream().map(constraintViolation -> {
        ...
        ErrorResponseDto errorRespDto = new ErrorResponseDto(
                ...
                validationErrorList.toString(),
                LocalDateTime.now()
        );

        return ResponseEntity.badRequest().body(errorRespDto);
    }
