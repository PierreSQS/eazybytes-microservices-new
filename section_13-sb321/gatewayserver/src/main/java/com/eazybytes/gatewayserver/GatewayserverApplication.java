	...
	public RouteLocator eazyBankRouteConfig(RouteLocatorBuilder routeLocatorBuilder) {
		return routeLocatorBuilder.routes()
						.route(p -> p
								...
								.filters( f -> f.rewritePath("/eazybank/accounts/(?<segment>.*)", $_SEGMENT)
					...
					.route(p -> p
							.path("/eazybank/loans/**")
							.filters( f -> f.rewritePath("/eazybank/loans/(?<segment>.*)", $_SEGMENT)
									.addResponseHeader(X_RESPONSE_TIME, LocalDateTime.now().toString())
					...
					.route(p -> p
							.path("/eazybank/cards/**")
							.filters( f -> f.rewritePath("/eazybank/cards/(?<segment>.*)", $_SEGMENT)
									.addResponseHeader(X_RESPONSE_TIME, LocalDateTime.now().toString())
